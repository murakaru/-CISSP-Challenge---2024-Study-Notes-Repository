...
- Capability Maturity Model (CMMI): Software developers maturity ratity 
- Six Sigma: Developed for identifying manufacturing defects but can be used to measure the success factors 
